...
export default function SettingsTab() {
  ...
  const [settings, setSettings] = useState<UserProfile>(() => {
    const saved = localStorage.getItem('dr_user_profile');
    return saved
      ? JSON.parse(saved)
      : {
          notifications: true,
  ...
  useEffect(() => {
    try {
      ...
      const existingProfile = JSON.parse(localStorage.getItem('dr_user_profile') || '{}');
      ...
      localStorage.setItem('dr_user_profile', JSON.stringify(updatedProfile));
